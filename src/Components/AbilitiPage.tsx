...
const AbilitiPage: React.FC<PropsType> = (props) => {
  ...
  return (
    <Container>
      <Button className={classes.root} onClick={clickToBackButton} variant="contained" color="primary">
        Back 
      </Button>
      <Card className={classes.root}>
        <CardActionArea className={classes.center}>
          <CardContent className={classes.textArea} >
            ...
            <Typography variant="h6" color="textSecondary" component="p">
              Pokemon: <ul className={classes.ulMargin}>
            ...
            <Typography variant="h6" color="textSecondary" component="p">
              Languages: <ul className={classes.ulMargin}>
