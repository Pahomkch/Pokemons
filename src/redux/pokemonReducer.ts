    ...
    pokemonsList: [
        {
            ...
            sprites: {front_default: 'https://via.placeholder.com/96', front_shiny: 'string', front_female: 'string', front_shiny_female: 'string',
                back_default: 'string', back_shiny: 'string', back_female: 'string', back_shiny_female: 'string' },
